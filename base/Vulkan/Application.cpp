...
namespace vk {
	...
	void Application::SetPhysicalDevice(VkPhysicalDevice physicalDevice)
	{
		...
		CreateUniformBufferAndSyncObjects();
		CreateSwapChain();
	...
	void Application::CreateSwapChain()
	{
		...
		depthBuffer_.reset(new class DepthBuffer(*commandPool_, swapChain_->Extent(), 1));
	...
	void Application::CreateUniformBufferAndSyncObjects()
	{
